...
- 사업계획서(26장): `docs/모아캘_사업계획서.pptx`(2026-09-09 갱신본: 모아캘 이름, 15초 흐름, 경쟁 부재, 다국어 타깃, 구현 현황, 카톡·문자 로드맵). 원본 `fall2026-schedule/InboxToCalendar_사업계획서.pptx`(09-08)도 남아 있음. 갱신 스크립트 방식: python-pptx로 기존 run 서식 유지하며 텍스트만 교체.
